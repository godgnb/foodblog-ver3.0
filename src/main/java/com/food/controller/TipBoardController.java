...
public class TipBoardController {
	...
	@PostMapping("/update")
	public ResponseEntity<String> update(MultipartFile file, TipBoardVO tipBoardVO, HttpServletRequest request,
				@RequestParam(required = false) String delFile, String pageNum) throws Exception {
		//=============== 게시글 수정 처리 시작 =================
		// 게시글 수정하는 메소드 호출
