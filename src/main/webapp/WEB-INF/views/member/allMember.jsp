                            ...
                            <div class="col-12 col-sm-6 col-lg-3">
                                <div class="form-group mb-30">
                                    <select class="form-control" id="member" onchange="window.open(value,'_self')">
                                      ...
                                      <option value="/member/allMember">전체회원정보보기</option>
                           ...
                           <c:if test="${ pageInfo.count gt 0 }">
                           		<ul class="pagination">
                           			...
                           			<c:if test="${ pageInfo.startPage gt pageInfo.pageBlock }">
                           				<li class="page-item">
	                            			<a href="/member/allMember?pageNum=${ pageInfo.startPage-pageInfo.pageBlock }&search=${ search }" class="page-link-move">[이전]</a>
	                           			</li>
                           			</c:if>
                           			<%--페이지블록 출력 --%>
                           				...
                           				<c:choose>
                           					<c:when test="${ i eq pageNum }">
                           						<li class="page-item active">
		                           					<a href="/member/allMember?pageNum=${ i }&search=${ search }" class="page-link">${ i }</a>
		                           				</li>
                           					</c:when>
                           					<c:otherwise>
                           						<li class="page-item">
                           			...
                           			<c:if test="${ pageInfo.endPage lt pageInfo.pageCount }">
                           				<li class="page-item">
	                           				<a href="/member/allMember?pageNum=${ pageInfo.startPage + pageInfo.pageBlock }&search=${ search }" class="page-link-move">[다음]</a>
	                       				</li>
                           			</c:if>
                           		</ul>
                           </c:if>
                        </nav>
                        <form action="/member/allMember" method="get">
	                        <div class="listwirte">
