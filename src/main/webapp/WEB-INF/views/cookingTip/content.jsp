                ...
                <div class="col-12 col-lg-8 col-xl-9">
					...
					<div class="post-a-comment-area mb-30 clearfix">
						...
						<c:if test="${id eq tipBoard.id}">
						    <div class="col-12">
						    	<input class="btn bueno-btn mt-30" type="button" value="글수정" onclick="location.href='/tipboard/updateForm?num=${tipBoard.num}&pageNum=${pageNum}';">
								<input class="btn bueno-btn mt-30" type="button" value="글삭제" onclick="checkDelete();">
						        <input class="btn bueno-btn mt-30" type="button" value="목록보기" onclick="location.href='/tipboard/tipboardForm?pageNum=${pageNum}';">
						    </div>
						</c:if>
					</div>
                </div>
...
function checkDelete() {
	...
	if (result == true) {
		location.href = '/tipboard/deleteForm?num=${tipBoard.num}&pageNum=${pageNum}';
	}
}
</script>
<script>
